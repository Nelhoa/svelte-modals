...
import ModalProps from './Modals/ModalProps.svelte';
...
export const index: title[] = [
	...
	},
	{
		title: 'Modal',
		items: [
			{ subtitle: `Props`, slug: 'modal-props', component: ModalProps },
	...
	},
	{
		title: 'Tooltip',
		items: [
			{ subtitle: `Props`, slug: 'tooltips-props', component: TooltipProps },
